...
const proxyRequest = request.defaults({ 'proxy': process.env.PROXY_URL });
...
Promise.promisifyAll(proxyRequest);
...
class LinePay {
    ...
    */
    reserve(options) {
        ...
        //     port: 443,
        //     path: `/${api_version}/payments/request`,
        //     method: 'POST',
        //     headers: this.headers,
        //     agent: this._getTunnelingAgent()
        // };
        // return this._postAsyncWithProxy(reqOptions, body, 'Reserving');
    }
    ...
    */
    confirm(options) {
        ...
        //     hostname: `${this.apiHostname}`,
        //     port: 443,
        //     path: `/${api_version}/payments/${options.transactionId}/confirm`,
        //     method: 'POST',
        //     headers: this.headers,
        //     agent: this._getTunnelingAgent()
        // };
        // return this._postAsyncWithProxy(reqOptions, body, 'Confirming');
    }

    // _postAsyncWithProxy(reqOptions, postData, type) {
    //     var lc = this._lossless_converter;
    ...
    //             res.on('data', (chunk) => {
    //                 data += chunk;
    //                 let body = lossless_json.parse(data, lc);
    //                 if (body.returnCode && body.returnCode == "0000") {
    //                     console.log(`${type} payment completed.`);
    //                     console.log(body);
    //                     return resolve(body);
    //                 } else {
    ...
    //             port: 80,
    //             proxyAuth: 'fixie:DUUnhpCO8SbSZ2a',
    //         }
    //     });
    // }
